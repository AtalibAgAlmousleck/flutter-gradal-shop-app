...
class ShoesCategroryScreen extends StatelessWidget {
  const ShoesCategroryScreen({super.key});
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            bottom: 0,
            right: 0,
            child: SiliderBar(menCategoryNmae: 'shoes'),
          ),
        ],
      ),
    );
